...
public class Jwt {
  //상수
  private static final String JWT_SECRET_KEY = "kosa12345"; //서버 쪽에서 가지고 있는 중요한 키. 암호화 해야 한다
  ...
  public static boolean validateToken(String token) {
    ...
    try {
      result = Jwts.parser()
                   ...
                   .getBody()
                   .getExpiration() //여기서 얻은 날짜가 현재 시간 보다 더 나중인지 물어봄. (남은 기간이 있는지를 물어보는 것)
                   .after(new Date());
  ...
  //Bearer xxxxxxxxx.xxxxxxxxxxxxxxx.xxxxxxxxxxxx
